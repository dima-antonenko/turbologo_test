module Logos
  module Creates
    class Filter
      ...
      def by_company_name
        self.templates = templates.joins(:company_leng_datas)
      ...
      def by_icon
        self.templates = templates.where(icon_required: true) unless icon_ids.empty?
      end

      def by_industry
        self.templates = templates.joins(:advanced_datas)
                                  .where(advanced_datas: { industry_id: industry_id })
      end
    end
  end
end